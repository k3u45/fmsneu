export default function Contact() {
  return (
    <section className="py-24 bg-white text-white" id="kontakt">
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16">
        ...
        <form className="bg-white p-8 space-y-4 rounded-sm ">
          ...
          <textarea placeholder="Beschreiben Sie Ihr Projekt in zwei Sätzen." rows={4} className="w-full p-4 bg-gray-50 border border-gray-200 text-black focus:border-red-600 outline-none" required />
